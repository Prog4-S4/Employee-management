...
public class EmployeeManagerDao {
    ...
    public List<EmployeeCnaps> findByEmployeCnapsCriteria(String lastName, String firstName, String countryCode, Sex sex, String position, DateRange entranceRange, DateRange departureRange, Pageable pageable) {
        CriteriaBuilder builder = entityManager.getCriteriaBuilder();
        CriteriaQuery<EmployeeCnaps> query = builder.createQuery(EmployeeCnaps.class);
        Root<EmployeeCnaps> root = query.from(EmployeeCnaps.class);
